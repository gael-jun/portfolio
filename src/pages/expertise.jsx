                ...
                <blockquote>
                  <div>
                    <p className="text-base text-primaryText-600 dark:text-primaryText-400">
                      {siteMetadata.expertise[0].testimonial}
                    </p>
                  </div>
                  <footer className="mt-3">
                    <div className="flex items-center space-x-3">
                      <div className="text-base font-medium text-primaryText-500">
                        {siteMetadata.expertise[0].testimonialAuthor},{' '}
                        {siteMetadata.expertise[0].testimonialAuthorTitle}
                      </div>
                    </div>
                  </footer>
                </blockquote>
            ...
            <div className="mt-12 sm:mt-16 lg:mt-0">
              <div className="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                <Image
                  ...
                  src={siteMetadata.expertise[0].imgUrl}
                  alt={siteMetadata.expertise[0].title}
                  width={2560}
                  height={1536}
                  title={siteMetadata.expertise[0].imageAttribution}
                />
              </div>
            </div>
          </div>
          ...
          <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
            <div className="max-w-xl px-4 mx-auto sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
              <div>
                ...
                <div className="mt-6">
                  <h2 className="text-3xl font-bold tracking-tight text-primaryText-800 dark:text-primaryText-100">
                    {siteMetadata.expertise[1].title}
                  </h2>
                  <p className="mt-4 text-lg text-primaryText-600 dark:text-primaryText-400">
                    {siteMetadata.expertise[1].description}
                  </p>
                  <div className="mt-6">
                    <Link
                      href="/contact"
            ...
            <div className="mt-12 sm:mt-16 lg:col-start-1 lg:mt-0">
              <div className="pr-4 -ml-48 sm:pr-6 md:-ml-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                <Image
                  ...
                  src={siteMetadata.expertise[1].imgUrl}
                  alt={siteMetadata.expertise[1].imageAttribution}
                  width={2560}
                  height={1536}
                  title={siteMetadata.expertise[1].imageAttribution}
                />
              </div>
            </div>
          </div>
