...
const projectsData = [
  ...
  {
    title: 'Semantic Book Recommender & RAG ChatBot with LLMs',
    description:
      'Data cleaning, semantic (vector) search with ChromaDB, zero-shot text classification (fiction vs non-fiction, ~78% accuracy), emotion analysis with RoBERTa, and a Retrieval-Augmented Generation (RAG) chatbot exposed via a Gradio web app.',
    logo: supaSnacksLogo,
    href: 'https://github.com/gael-jun/book-recommander',
    category: 'LLMs / NLP / RAG / Recommenders',
    skills: [
      'LangChain',
      'RAG',
      'Transformers',
